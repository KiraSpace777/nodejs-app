...
// npm init -y <!-- === Ініціалізуйте npm: З’явиться файл package.json із базовою інформацією про проєкт. -->

// npm install -D nodemon <!-- === пакет nodemon автоматично перезапускає застосунок після змін у файлах. -->

// npm init @eslint/config@latest <!-- === Лінтинг коду, дозволяє задати єдиний стиль написання коду -->

// npm install express <!-- ===  мінімалістичний веб-фреймворк для Node.js -->

// npm install cors <!-- === Cross-Origin Resource Sharing — механізм безпеки, який дозволяє браузеру робити запити з одного домену до іншого -->

// npm install pino-http pino-pretty <!-- ===  Логування запитів (логер pino-http), вхідні/вихідні запити, час обробки -->
